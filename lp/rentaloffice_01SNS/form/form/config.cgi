...
##@mailto = ('yoshifumi_ohtani@marukin-ad.co.jp');
###@mailto = ('# 複数の場合 (シングルクォートでくくったメールアドレスをカンマで区切って指定);
@mailto = ('Satomi.Kawasaki@regus.com','Kazuki.nishikawa@regus.com','Masayuki.Uwabo@regus.com','Ryoko.Kawashima@regus.com','Nufang.Huang@regus.com','Li.Peng@regus.com','Japan.SEM@regus.com','info.asia@regus.com');

##フォームからの差出人
##$config{"mailfrom"} = $mailto[0];
$config{"mailfrom"} = 'webmaster@regus.com';


##フォームの差出人名
$config{"fromname"} = 'webmaster@regus.com';
...
<date>
レンタルオフィスに関するお問い合わせフォームより以下のメールを受付ました。
────────────────────────────────────
受付番号：<serial>
入力時間：<input_time>
...
この度は日本リージャス株式会社のレンタルオフィスにお問い合わせ頂き誠にありがとうございました。
後ほど専門スタッフよりおり返しご連絡いたしますので
しばらくお待ちくださいませ。
