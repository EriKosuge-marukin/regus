...
The following inquiry has been made by a {culture} user - the page they came from was https://www.regus-office.jp/lp/spaces/.
...
##送信者に届く自動返信メールの件名
$config{"return_subject"} = 'イベントスペース無料利用キャンペーンへのお申込み、ありがとうございました';
...
イベントスペース無料利用キャンペーンへお申込みいただき、誠にありがとうございます。
...
現在、世界120ヶ国3,000拠点以上、国内では24都市114拠点にてレンタルオフィス事業を展開し
...
また、羽田空港第1ターミナル、関西国際空港など、空港内への展開も進めております。
