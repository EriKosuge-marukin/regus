...
##設置者に届くメールの件名
$config{"subject"} = 'テレワーク・ディご利用について';
...
The following inquiry has been made by a {culture} user - the page they came from was https://www.regus-office.jp/lp/telework/.
...
##送信者に届く自動返信メールの件名
$config{"return_subject"} = 'テレワーク・ディご利用のお申込み、ありがとうございました';
...
こちらのメールを
Regus、Regus Express、SPACESの受付スタッフにお見せください。

＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
テレワークDay　キャンペーン

全国80拠点のRegus、Regus Express、SPACESのワークスペース
をご利用いただけます。
https://www.regus-office.jp/services-business-lounges/

7月23日（月）～27日（金）8:30～18:00

・お客様1名様、期間中1回（1日）のご利用に限らせていただきます
・満室、満席の場合は、ご利用いただけない場合がございます
　予め、ご了承ください。
...
現在、世界120ヶ国3,000拠点以上、国内では32都市125拠点にてレンタルオフィス事業を展開し
フォーチュン500企業の半数から、個人起業家のお客様まで、幅広い層のお客様に
ご利用いただいております。

新宿パークタワー、渋谷マークシティ、横浜ランドマークタワー、大名古屋ビルヂング
阪急グランドビル、大阪国際ビル、JRJP博多ビル、札幌北ビル、仙台マークワンなど、
国内有数のランドマークビルにリージャスビジネスセンターを展開いたしております。

また、羽田空港第1ターミナル、関西国際空港など、空港内へもリージャスエクスプレスを展開。
...
●時間貸会議室●https://www.regus-office.jp/service/meetingroom/meetingroom/
...
まずはご説明およびご内覧のご希望は、
下記フォームからお気軽にご予約ください。
最寄りのセンターにてお客様に最適なオフィスを、所要時間約1時間でご案内いたします。
