...
?>
            ...
            <tr>
              <th align="left">Eメール <span class="required">（必須）</span></th>
              <td>
                <input name="mail" type="text" id="mail" placeholder="sample@sample.jp" value="<?php echo(isset($mail)?$mail:""); ?>" size="50" maxlength="80" class="formsize2" <?php if (isset($error["mail"])) { ?>style="background-color: #FFDDDD"<?php } ?>>
<?php
if (isset($error["mail"])) {
?>
