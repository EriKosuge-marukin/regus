...
<td><input type="text" size="50" maxlength="50" name="fax" value="<?php echo (isset($fax)?$fax:"");?>" class="formsize2">
</td>
</tr>
...
<td>
	<label for="free2_0" class="officeblk osakahigobashi"><input id="free2_0" name="" type="checkbox" class="checkbox" value="大阪肥後橋 "></label>
	<span class="officename">大阪肥後橋  </span>
	

<script type="text/javascript">Checkbox_free2.draw("<?php echo (isset($free2)?str_replace(array("\r\n","\r","\n"), "/", $free2):(isset($office)?$office:""));?>")</script>
<noscript>
<textarea name="free2" rows="3" cols="50" class="formsize1"><?php echo (isset($free1)?$free1:"横浜金港町 / 大門駅前 / 五反田駅西口 /  本厚木駅前 / 豊田 / 西新宿駅前 / 刈谷 / 神戸三宮南 / 大分 / 新潟 / 名古屋丸の内 / 新大阪北 / 立川駅南 / 熊本銀座通り / 仙台駅前 / 西新橋 / 名駅南 / 渋谷神南 / 広島大手町 / 日本橋箱崎 / 神保町 / 博多駅前通り / 小倉 /水戸 / 札幌南 / 京都烏丸 / 池袋 / 赤坂ビジネスプレイス / 青山セントラル / 南青山 / 麻布十番 / 赤坂見附 / 溜池山王 / 渋谷hills / 乃木坂 / 渋谷TOC / 仙台青葉通り / 日本橋セントラル / 新宿ウエスト / 京都川原町 / 名古屋伏見 / 京阪淀屋橋 / バーチャルオフィス");?></textarea>
<p>※該当しないものを削除してください。</p>
</noscript>
...
?>
<p id="free3_blk" style="line-height:1.5em;" class="frm_txt_m10">希望する部屋が具体的にあればご記入下さい。<br><input name="free3" type="text" size="50" value="<?php echo ($free3?$free3:(isset($fullOffice)?$fullOffice:""));?>" class="formsize2"><br>
<span class="block">例：「青山セントラル5F F, 日本橋セントラル6FS-2」など</span></p>
</td>
</tr>

<tr><th align="left">お問い合わせ詳細</th>
<td><textarea name="free6" rows="5" cols="40" class="formsize1"><?php echo (isset($free6)?$free6:"");?></textarea>
<!--p class="mark-indent10">※人気のため見学ご予約が混み合う場合がございます。<br>
ご利用をお急ぎの場合は、その旨をご記載くださいませ。優先してご案内を致します。</p-->
</td>
</tr>
