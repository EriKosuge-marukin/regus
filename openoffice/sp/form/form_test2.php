...
<link href="css/officeform_.css" rel="stylesheet" type="text/css">
...
<td><script type="text/javascript">Checkbox_free2.draw("<?php echo (isset($free2)?str_replace(array("\r\n","\r","\n"), "/", $free2):(isset($office)?$office:""));?>")</script>
<noscript>
...
?>
<p id="free3_blk" style="line-height:1.5em;">希望する部屋が具体的にあればご記入下さい。<br><input name="free3" type="text" size="50" value="<?php echo ($free3?$free3:(isset($fullOffice)?$fullOffice:""));?>" class="formsize2"><br>
