...
-----------------------------------------------";
	...
	$from .= 'Bcc: relay@regus-office.jp';//本番アドレス
    // $from .= 'Bcc: isi@lc93.jp';
      ...
      <div class="subblock_Fm">
        ...
        <form name="form1" method="post" action="<?php echo $_SERVER["PHP_SELF"];?> ">
          ...
          <p class="form-submit">
            ...
            <input id="submit_button_2" type="submit" value="送信" onclick="document.getElementById('mode').value='send'"/>
          </p>
