...
//		$from .= 'Bcc: yoshifumi_ohtani@marukin-ad.co.jp,tam@lc93.jp,isi@lc93.jp';
...
<tr>
	...
	<td><input type="text" size="50" maxlength="50" name="center" value="<?php echo $center;?>" class="formsize1" disabled="disabled">
	</td>
</tr>

<tr>
	<th align="left">見学予約を希望する</th>
	<!--td><input type="checkbox" name="visit" value="yes"<?php if ($visit=="yes") echo " checked"; ?> disabled="disabled"> する</td-->
	<td><?php echo ($visit=="yes") ? "する" : "しない";?></td>
</tr>
