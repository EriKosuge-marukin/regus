...
var Checkbox_free2 = new MergeCheckBox (
    {
        id : "free2",
        data : [
			{css:"osakahigobashi", name:"大阪肥後橋 "},
			{css:"osakahirano", name:"大阪平野町 "},
			{css:"takamatsu", name:"高松 "},
			{css:"omiyaekinishi", name:"大宮駅西口 "},
			{css:"moriokaodori", name:"盛岡大通 "},
		{css:"kinkoucho", name:"横浜金港町 "},
		{css:"daimonekimae", name:"大門駅前 "},
		{css:"gotandaekinishi", name:"五反田駅西口 "},
		{css:"honatsugi", name:"本厚木駅前 "},
